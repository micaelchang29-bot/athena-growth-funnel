...
-- raw_product_events viene de OpenCSVSerde y tiene TODAS sus columnas como
-- STRING (incluido event_timestamp y amount), lo que rompería cualquier
-- resta de fechas o promedio numérico sin castear primero. product_events_parquet
-- ya trae event_timestamp como TIMESTAMP y amount como DOUBLE (casteados en
-- 02_ctas_parquet_partitioned.sql), además de estar particionada por
-- year/month para escanear menos bytes.
-- =============================================================================

-- ===== SENTENCIA 1: usuarios únicos por evento de la secuencia + % de conversión =====
...
-- ===== SENTENCIA 2: tiempo promedio entre cada par de eventos consecutivos (horas) =====
